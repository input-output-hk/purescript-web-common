...
foreign import _scrollTo
  :: { left :: Number, top :: Number, behavior :: String }
  -> Element
  -> Effect Unit
...
scrollTo
  ...
  -> Element
  -> Effect Unit
scrollTo behavior { left, top } = _scrollTo
  { left, top, behavior: scrollBehaviorToFFI behavior }

foreign import _scrollIntoView
  :: { block :: String, inline :: String, behavior :: String }
  -> Element
  -> Effect Unit

scrollIntoView
  :: { block :: Alignment, inline :: Alignment, behavior :: ScrollBehavior }
  -> Element
  -> Effect Unit
...
foreign import throttledOnScroll
  :: Number
  -> Element
  -> ({ left :: Number, top :: Number } -> Effect Unit)
  -> Effect (Effect Unit)

foreign import debouncedOnScroll
  :: Number
  -> Element
  -> ({ left :: Number, top :: Number } -> Effect Unit)
  -> Effect (Effect Unit)
