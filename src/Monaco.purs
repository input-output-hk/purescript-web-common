...
foreign import completionItemKindEq_ :: Fn2 CompletionItemKind
  CompletionItemKind
  Boolean
...
foreign import completionItemKindOrd_ :: Fn5 Ordering Ordering Ordering
  CompletionItemKind
  CompletionItemKind
  Ordering
...
foreign import setMonarchTokensProvider_ :: EffectFn3 Monaco String
  MonarchLanguage
  IDisposable

foreign import setModelMarkers_ :: EffectFn4 Monaco ITextModel String
  (Array IMarkerData)
  Unit
...
foreign import getDecorationRange_ :: EffectFn2 ITextModel String
  (Nullable IRange)

foreign import setStrictNullChecks_ :: EffectFn2 Monaco Boolean Unit

foreign import setDeltaDecorations_ :: EffectFn3 Editor (Array String)
...
foreign import setTokensProvider_ :: EffectFn3 Monaco String TokensProvider
  IDisposable
...
foreign import registerHoverProvider_ :: EffectFn3 Monaco String HoverProvider
  IDisposable

foreign import registerCompletionItemProvider_ :: EffectFn3 Monaco String
  CompletionItemProvider
  IDisposable

foreign import registerCodeActionProvider_ :: EffectFn3 Monaco String
  CodeActionProvider
  IDisposable

foreign import registerDocumentFormattingEditProvider_ :: EffectFn3 Monaco
  String
